...
public class Constantes {
	...
	public static final Float CONST_TARJETA		       = (float) 0.65;  // Probabilidad m�nima para que haya tarjeta
	public static final Float CONST_TARJETA_AMARILLA   = (float) 0.90; // Probabilidad m�xima para que sea tarjeta amarilla
	...
	public static final String[] CONST_MENSAJES_REGATE_BAJO  = {"Tiro sin trayectoria definida que no tiene destino de arco.", "Disparo que se va tres metros desviado.", "Potente disparo de larga distancia que controla el arquero.", "Tiro que sale por encima del travesa�o."};
